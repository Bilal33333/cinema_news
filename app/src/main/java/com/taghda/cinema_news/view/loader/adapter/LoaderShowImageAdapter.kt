package com.taghda.cinema_news.view.loader.adapter
...
class LoaderShowImageAdapter :
    PagingDataAdapter<Search, RecyclerView.ViewHolder>(REPO_COMPARATOR) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as? ShowsImageViewHolder)?.bind(item = getItem(position))
    }
